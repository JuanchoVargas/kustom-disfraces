...
onMounted(() => {
  if (route.query.demo && cart.items.length === 0) {
    cart.add({ productId: 1, name: 'Spider-Man Clásico', slug: 'spider-man-clasico', sku: '001001001', price: 130000, image: '/images/products/spider-man-clasico.webp', size: 6, gama: 'Súper Acolchado', quantity: 1 })
    cart.add({ productId: 49, name: 'Pollito', slug: 'pollito', sku: '001011001', price: 89000, image: '/images/products/pollito.webp', size: 'Bebé', quantity: 2 })
  }
})
...
// Pago con Mercado Pago (Checkout Pro) — CTA principal; WhatsApp queda como alternativa.
  ...
  <div class="cart">
    ...
    <div v-else class="cart__layout">
      ...
      <aside class="summary">
        ...
        <KButton variant="primary" size="lg" block :loading="mpLoading" @click="payMP">Pagar con Mercado Pago</KButton>
        <p v-if="mpError" class="summary__mperror" role="alert">{{ mpError }}</p>
